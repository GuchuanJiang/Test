...
public class AnimViewPager extends ViewPager {
	...
	public AnimViewPager(Context context, AttributeSet attrs) {
		...
		int effect = ta.getInt(R.styleable.AnimViewPager_style, 0);
		...
		setOutlineEnabled(ta.getBoolean(R.styleable.AnimViewPager_outlineEnabled, false));
		setOutlineColor(ta.getColor(R.styleable.AnimViewPager_outlineColor, Color.WHITE));
		switch (mEffect) {
		case Stack:
		case ZoomOut:
			setFadeEnabled(true);
